/* Leetcode - 52. N-Queens II (Java language) - Hard */

import java.util.Arrays;

public class n_queens_52 {
    public static void main(String[] args) {
        System.out.println(yellow("Leetcode - 52. N-Queens II (Java language) - ") + red("Hard"));
        int[] n = {4,1};

        for (int test = 0; test < n.length; test++) {
            System.out.print(green("Test " + (test + 1) + ": "));
            System.out.print(solveNQueens(n[test]) + " | ");
            System.out.println(green("Passed"));
        }
    }

    public static int solveNQueens(int nVar) {
