/* Leetcode - 116. Populating Next Right Pointers in Each Node (Java language) - Medium */
...
public class populating_next_right_pointers_in_each_node_116 {
    public static void main(String[] args) {
        System.out.println(yellow("Leetcode - 116. Populating Next Right Pointers in Each Node (Java language) - Medium"));
