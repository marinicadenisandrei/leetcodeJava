/* Leetcode - 127. Word Ladder (Java language) - Hard */
...
public class word_ladder_127 {
    public static void main(String[] args) {
        System.out.println(yellow("Leetcode - 127. Word Ladder (Java language) - ") + red("Hard"));
    ...
    public static int FindLadders(String beginStringVar, String endWordVar, ArrayList<String> wordListVar) {
