...
public class best_time_to_buy_and_sell_stock_III_123 {
    public static void main(String[] args) {
        System.out.println(yellow("Leetcode - 123. Best Time to Buy and Sell Stock III (Java language) - Medium"));

        int[][] prices = {{3,3,5,0,0,3,1,4},{1,2,3,4,5},{7,6,4,3,1}};
    ...
    public static int maxProfit(int[] pricesVar) {
        ...
        pricesVar = Arrays.copyOf(pricesVar, pricesVar.length + 1);
        pricesVar[pricesVar.length - 1] = -1;
